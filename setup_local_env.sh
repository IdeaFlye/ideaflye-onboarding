...
if kubectl get secret $GCS_KEY_SECRET &>/dev/null; then
    ...
    # Offer to create from the previously supplied content
    if confirm "Would you like to create the gcs-key.json file from previously supplied content?"; then
        cat > "$GCS_KEY_FILE" << 'EOLFIX'
{
  "type": "service_account",
  "project_id": "vm-server-setup-1",
  "private_key_id": "8b5c20db8c4c7789ed1c24250beede7b24227740",
  "private_key": "-----BEGIN PRIVATE KEY-----\\nf5UEUMgHi6k2VLcxeIRJ\n-----END PRIVATE KEY-----\n",
  "client_email": "ideaflye-storage@vm-server-setup-1.iam.gserviceaccount.com",
  "client_id": "113008230697386303665",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/ideaflye-storage%40vm-server-setup-1.iam.gserviceaccount.com",
  "universe_domain": "googleapis.com"
}
EOLFIX
        echo -e "${GREEN}✓ GCS key file created at $GCS_KEY_FILE from provided content${NC}"
    else
        echo -e "${YELLOW}GCS key file not created. Server may not be able to access Google Cloud Storage.${NC}"
    fi
fi
